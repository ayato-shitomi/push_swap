...
// align_stacks.c
void	calcul_align_a(size_t *pos, size_t *mvt, t_stack *stack_a, t_stack *stack_b);
...
void			execute_instructions(t_instruction *instr, t_stack *stack_a, t_stack *stack_b);
...
// bruteforce.c
int		bruteforce_choice_a(t_state **new_states, t_state *tmp, size_t pos[2], t_stack *stack_b);
int		reverse_rotate_bruteforce_a(t_state **new_states, t_state *tmp, size_t pos[2], t_stack *stack_b);
int		bruteforce_order_a(t_program *prg);
int		rotate_bruteforce_a(t_state **new_states, t_state *tmp, size_t pos[2], t_stack *stack_b);
...
// less_mvt.c
size_t	less_mvt_at_begin(size_t minimal_mvt, size_t *min_mvt, t_stack *stack_a, t_stack *stack_b);
size_t	less_mvt_at_end(size_t minimal_mvt, size_t *min_mvt, t_stack *stack_a, t_stack *stack_b);
